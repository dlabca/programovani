...
{
    static readonly List<BluetoothClientHandler> clients = new List<BluetoothClientHandler>();
    ...
    static void Main()
    {
        ...
        listener.Start();
        Console.WriteLine("Bluetooth server spuštěn a čeká na klienty...");
        ...
        while (true)
        {
            ...
            BluetoothClientHandler clientHandler = new BluetoothClientHandler(client);
    ...
    public static void RemoveClient(BluetoothClientHandler client)
    {
        lock (clients)
        {
...
class BluetoothClientHandler
{
    ...
    public BluetoothClientHandler(BluetoothClient client)
    {
        this.client = client;
    ...
    public void HandleClient()
    {
        try
        {
            ...
            BluetoothServer.Broadcast($"{clientName} se připojil.", "Server");
        ...
        finally
        {
            ...
            BluetoothServer.Broadcast($"{clientName} opustil chat.", "Server");
            client.Close();
        }
    }
