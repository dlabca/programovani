...
namespace DungeonCrawler
{
    ...
    class Game
    {
        ...
        private void SetupRooms()
        {
            ...
            Room room5 = new Room("zbrojírna", "Jste ve zbrojírně , je tady několik brnění");
            ...
            room5.AddItem(new Item("platynove brneni", 6));
            room5.AddItem(new Item("platynove brneni", 6));
            room5.AddItem(new Item("diamantové brneni", 10));
